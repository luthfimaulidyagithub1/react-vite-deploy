// src/ui-component/cards/statistik/TabelLuasArealPerkebunanCard.jsx
...
export default function TabelLuasArealPerkebunanCard({ isLoading, data, tahun }) {
  ...
  useEffect(() => {
    ...
    // filter kategori: "Luas Areal (ha)" dan tahun
    let filtered = data.filter(
      (item) => String(item.kategori).toLowerCase().trim() === 'luas areal (ha)' && String(item.tahun) === String(tahun)
    );
  ...
  return (
    <Card sx={{ borderRadius: 2, height: '100%' }}>
      <CardContent>
        ...
        >
          Luas Areal (Ha) Perkebunan Menurut Jenis Tanaman di Kabupaten/Kota, {tahun}
        </Typography>
...
TabelLuasArealPerkebunanCard.propTypes = {
