...
export default function ProduksiKayuHutanCard({ isLoading, data, tahun }) {
  const theme = useTheme();
  const [produksiKayu, setProduksiKayu] = useState(0);
  ...
  useEffect(() => {
    ...
    // hitung total produksi kayu (m3) dari field "jumlah"
                ...
                <ListItemText
                  ...
                  primary={
                    <Typography variant="h4" sx={{ color: '#000' }}>
                      {produksiKayu > 0 ? `${produksiKayu.toLocaleString('id-ID')} m³` : '0 m³'}
                    </Typography>
                  }
                  secondary={
                    <>
                      <Typography variant="subtitle2" sx={{ color: '#000', mt: 0.25 }}>
                        Produksi Kayu Hutan, Tahun {tahun}
                      </Typography>
...
ProduksiKayuHutanCard.propTypes = {
