...
export default function ProduksiSayuranCard({ isLoading, data, tahun, kecamatan }) {
  ...
  useEffect(() => {
    ...
    // filter kategori: Sayuran Semusim & Sayuran Tahunan
    let filtered = data.filter((item) => {
      const kategori = String(item.kategori).toLowerCase().trim();
      return kategori === 'sayuran semusim' || kategori === 'sayuran tahunan';
    });
                  ...
                  secondary={
                    <>
                      <Typography variant="subtitle2" sx={{ color: '#000', mt: 0.25 }}>
                        Produksi Sayuran (Semusim+Tahunan) di Kec. {kecamatan}, {tahun}
                      </Typography>
