// DonutPanenSayurTahunanCard.jsx
...
export default function DonutPanenSayurTahunanCard({ isLoading, data, tahun, kecamatan }) {
  ...
  useEffect(() => {
    ...
    // filter kategori SayurTahunanan Tahunan + tahun + kecamatan
    let filtered = data.filter(
      (item) =>
        String(item.kategori).toLowerCase().trim() === 'sayuran tahunan' &&
    ...
    >
      <CardContent sx={{ display: 'flex', flexDirection: 'column', height: '100%' }}>
        ...
        <Typography variant="subtitle1" sx={{ fontWeight: 600, mb: 2, color: theme.palette.text.primary, textAlign: 'center' }}>
          Distribusi Produksi (Kwintal) Sayuran Tahunan di Kecamatan {kecamatan}, {tahun}
        </Typography>
...
DonutPanenSayurTahunanCard.propTypes = {
