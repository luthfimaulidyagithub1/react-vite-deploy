...
export default function LuasPanenBiofarmakaCard({ isLoading, data, tahun, kecamatan }) {
                  ...
                  secondary={
                    <>
                      <Typography variant="subtitle2" sx={{ color: '#000', mt: 0.25 }}>
                        Luas Panen Tanaman Biofarmaka di Kec. {kecamatan}, {tahun}
                      </Typography>
...
LuasPanenBiofarmakaCard.propTypes = {
