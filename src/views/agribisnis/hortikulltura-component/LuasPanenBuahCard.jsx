...
export default function LuasPanenBuahCard({ isLoading, data, tahun, kecamatan }) {
  ...
  useEffect(() => {
    ...
    // filter kategori: Buah-Buahan Semusim
    let filtered = data.filter((item) => String(item.kategori).toLowerCase().trim() === 'buah-buahan semusim');
                  ...
                  secondary={
                    <>
                      <Typography variant="subtitle2" sx={{ color: '#000', mt: 0.25 }}>
                        Luas Panen Buah-Buahan Semusim di Kec. {kecamatan}, {tahun}
                      </Typography>
