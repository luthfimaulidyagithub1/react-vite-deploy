// DonutPanenSayurSemusimCard.jsx
...
export default function DonutPanenSayurSemusimCard({ isLoading, data, tahun, kecamatan }) {
  ...
  useEffect(() => {
    ...
    // filter kategori SayurSemusiman Semusim + tahun + kecamatan
    let filtered = data.filter(
      (item) =>
        String(item.kategori).toLowerCase().trim() === 'sayuran semusim' &&
    ...
    >
      <CardContent sx={{ display: 'flex', flexDirection: 'column', height: '100%' }}>
        ...
        <Typography variant="subtitle1" sx={{ fontWeight: 600, mb: 2, color: theme.palette.text.primary, textAlign: 'center' }}>
          Distribusi Produksi (Kwintal) Sayuran Semusim di Kecamatan {kecamatan}, {tahun}
        </Typography>
...
DonutPanenSayurSemusimCard.propTypes = {
