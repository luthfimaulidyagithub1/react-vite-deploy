...
export default function DonutPanenBiofarmakaCard({ isLoading, data, tahun, kecamatan }) {
  ...
  useEffect(() => {
    ...
    // filter kategori Biofarmakaan Tahunan + tahun + kecamatan
    let filtered = data.filter(
      (item) =>
        String(item.kategori).toLowerCase().trim() === 'biofarmaka' &&
    ...
    >
      <CardContent sx={{ display: 'flex', flexDirection: 'column', height: '100%' }}>
        ...
        <Typography variant="subtitle1" sx={{ fontWeight: 600, mb: 2, color: theme.palette.text.primary, textAlign: 'center' }}>
          Distribusi Produksi (Kwintal) Tanaman Biofarmaka di Kecamatan {kecamatan}, {tahun}
        </Typography>
...
DonutPanenBiofarmakaCard.propTypes = {
