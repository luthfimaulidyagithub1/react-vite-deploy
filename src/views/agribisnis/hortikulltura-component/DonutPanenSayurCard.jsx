...
export default function DonutPanenSayurCard({ isLoading, data, tahun, kecamatan }) {
  ...
  useEffect(() => {
    ...
    // filter kategori Sayuran Semusim + tahun + kecamatan
    ...
    >
      <CardContent sx={{ display: 'flex', flexDirection: 'column', height: '100%' }}>
        ...
        <Typography variant="subtitle1" sx={{ fontWeight: 600, mb: 2, color: theme.palette.text.primary, textAlign: 'center' }}>
          Distribusi Luas Panen (Ha) Sayuran Semusim di Kecamatan {kecamatan}, {tahun}
        </Typography>
