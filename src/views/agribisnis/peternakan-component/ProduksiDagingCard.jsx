...
export default function ProduksiDagingCard({ isLoading, data, tahun, kecamatan }) {
  ...
  useEffect(() => {
    ...
    // filter tahun + kecamatan + kategori Daging
    ...
    const total = filtered.reduce((sum, item) => {
      let val = item['produksi daging/unggas (kg)'] ?? 0;
                ...
                <ListItemText
                  ...
                  primary={
                    <Typography variant="h4" sx={{ color: '#000' }}>
                      {produksi > 0
                        ? `${produksi.toLocaleString('id-ID', { minimumFractionDigits: 2, maximumFractionDigits: 2 })} kg`
                        : '0 kg'}
                    </Typography>
                  }
                  secondary={
                    <>
                      <Typography variant="subtitle2" sx={{ color: '#000', mt: 0.25 }}>
                        Produksi Daging di Kec. {kecamatan}, {tahun}
                      </Typography>
