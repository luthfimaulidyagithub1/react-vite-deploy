...
export default function ProduksiUnggasCard({ isLoading, data, tahun, kecamatan }) {
                  ...
                  secondary={
                    <>
                      <Typography variant="subtitle2" sx={{ color: '#000', mt: 0.25 }}>
                        Produksi Unggas di Kec. {kecamatan}, {tahun}
                      </Typography>
