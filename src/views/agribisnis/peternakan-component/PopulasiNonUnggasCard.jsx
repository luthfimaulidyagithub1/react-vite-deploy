...
export default function PopulasiNonUnggasCard({ isLoading, data, tahun, kecamatan }) {
                  ...
                  secondary={
                    <>
                      <Typography variant="subtitle2" sx={{ color: '#000', mt: 0.25 }}>
                        Populasi Non Unggas di Kec. {kecamatan}, {tahun}
                      </Typography>
...
PopulasiNonUnggasCard.propTypes = {
