...
export default function PieProduksiPerikananCard({ isLoading, data, tahun, kecamatan }) {
  ...
  useEffect(() => {
    ...
    // kelompokkan berdasarkan subsektor
    const grouped = {};
    filtered.forEach((item) => {
      const key = item['subsektor'] || 'Tidak Diketahui';
      const jumlah = toNumber(item['produksi (ton)']);
    ...
    >
      <CardContent sx={{ display: 'flex', flexDirection: 'column', height: '100%' }}>
        ...
        <Typography variant="subtitle1" sx={{ fontWeight: 600, mb: 2, color: theme.palette.text.primary, textAlign: 'center' }}>
          Distribusi Produksi (Ton) Perikanan Tangkap menurut Subsektor di Kec. {kecamatan}, {tahun}
        </Typography>
...
PieProduksiPerikananCard.propTypes = {
