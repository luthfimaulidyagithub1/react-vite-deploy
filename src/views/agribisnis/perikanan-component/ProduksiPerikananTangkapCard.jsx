// ProduksiPerikananTangkapCard.jsx
...
const CardWrapper = styled(MainCard)(({ theme }) => ({
  overflow: 'hidden',
  position: 'relative',
  border: `1px solid ${theme.palette.info ? theme.palette.orange.main : theme.palette.primary.main}`,
...
export default function ProduksiPerikananTangkapCard({ isLoading, data, tahun, kecamatan }) {
                  ...
                  secondary={
                    <>
                      <Typography variant="subtitle2" sx={{ color: '#000', mt: 0.25 }}>
                        Total Produksi Perikanan Tangkap di Kec. {kecamatan}, {tahun}
                      </Typography>
...
ProduksiPerikananTangkapCard.propTypes = {
