...
export default function RutaBudidayaCard({ isLoading, data, tahun, kecamatan }) {
                  ...
                  secondary={
                    <>
                      <Typography variant="subtitle2" sx={{ color: '#000', mt: 0.25 }}>
                        Rumah Tangga Perikanan Budidaya di Kec. {kecamatan}, {tahun}
                      </Typography>
