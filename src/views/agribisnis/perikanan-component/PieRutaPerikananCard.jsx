...
export default function PieRutaPerikananCard({ isLoading, data, tahun, kecamatan }) {
    ...
    >
      <CardContent sx={{ display: 'flex', flexDirection: 'column', height: '100%' }}>
        ...
        <Typography variant="subtitle1" sx={{ fontWeight: 600, mb: 2, color: theme.palette.text.primary, textAlign: 'center' }}>
          Distribusi Rumah Tangga Perikanan Tangkap menurut Subsektor di Kec. {kecamatan}, {tahun}
        </Typography>
        ...
        <Box sx={{ display: 'flex', flex: 1 }}>
          <Box sx={{ flex: 1, height: 280 }}>
            {isDataEmpty ? (
              ...
              >
                Tidak terdapat ruta perikanan tangkap
              </Typography>
            )}
          </Box>
        </Box>
...
PieRutaPerikananCard.propTypes = {
