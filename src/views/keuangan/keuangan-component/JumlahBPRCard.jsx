...
export default function JumlahBPRCard({ isLoading, data, tahun, kecamatan }) {
  ...
  useEffect(() => {
    ...
    // hitung total bank pengkreditan rakyat
                ...
                <ListItemText
                  ...
                  primary={
                    <Typography variant="h4" sx={{ color: '#000' }}>
                      {jumlahBank > 0 ? `${jumlahBank.toLocaleString('id-ID')} BPR` : '0 BPR'}
                    </Typography>
                  }
                  secondary={
                    <>
                      <Typography variant="subtitle2" sx={{ color: '#000', mt: 0.25 }}>
                        Jumlah BPR di Kec. {kecamatan}, {tahun}
                      </Typography>
