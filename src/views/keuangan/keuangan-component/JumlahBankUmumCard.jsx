...
export default function JumlahBankUmumCard({ isLoading, data, tahun, kecamatan }) {
  ...
  useEffect(() => {
    ...
    // hitung total bank umum pemerintah
    const total = filtered.reduce((sum, item) => {
      let val = item['bank umum pemerintah'] ?? 0;
                ...
                <ListItemText
                  ...
                  primary={
                    <Typography variant="h4" sx={{ color: '#000' }}>
                      {jumlahBank > 0 ? `${jumlahBank.toLocaleString('id-ID')} Bank Umum` : '0 Bank Umum'}
                    </Typography>
                  }
                  secondary={
                    <>
                      <Typography variant="subtitle2" sx={{ color: '#000', mt: 0.25 }}>
                        Jumlah Bank Umum Pemerintah di Kec. {kecamatan}, {tahun}
                      </Typography>
