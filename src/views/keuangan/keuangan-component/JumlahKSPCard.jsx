...
export default function JumlahKSPCard({ isLoading, data, tahun, kecamatan }) {
  const theme = useTheme();
  const [jumlahKSP, setJumlahKSP] = useState(0);
                ...
                <ListItemText
                  ...
                  primary={
                    <Typography variant="h4" sx={{ color: '#000' }}>
                      {jumlahKSP > 0 ? `${jumlahKSP.toLocaleString('id-ID')} KSP` : '0 KSP'}
                    </Typography>
                  }
                  secondary={
                    <>
                      <Typography variant="subtitle2" sx={{ color: '#000', mt: 0.25 }}>
                        Jumlah KSP di Kec. {kecamatan}, {tahun}
                      </Typography>
