...
export default function JumlahKUDCard({ isLoading, data, tahun, kecamatan }) {
  const theme = useTheme();
  const [jumlahKUD, setJumlahKUD] = useState(0);
                ...
                <ListItemText
                  ...
                  primary={
                    <Typography variant="h4" sx={{ color: '#000' }}>
                      {jumlahKUD > 0 ? `${jumlahKUD.toLocaleString('id-ID')} KUD` : '0 KUD'}
                    </Typography>
                  }
                  secondary={
                    <>
                      <Typography variant="subtitle2" sx={{ color: '#000', mt: 0.25 }}>
                        Jumlah KUD di Kec. {kecamatan}, {tahun}
                      </Typography>
