...
import JumlahSekolahCard from './pendidikan-component/JumlahSekolahCard';
import JumlahSekolahNegeriCard from './pendidikan-component/JumlahSekolahNegeriCard';
import JumlahSekolahSwastaCard from './pendidikan-component/JumlahSekolahSwastaCard';
import BarJumlahDesaSekolahCard from './pendidikan-component/BarJumlahDesaSekolahCard';
import DonutFasilitasSekolahCard from './pendidikan-component/DonutFasilitasSekolahCard';
import JumlahGuruCard from './pendidikan-component/JumlahGuruCard';
import JumlahGuruNegeriCard from './pendidikan-component/JumlahGuruNegeriCard';
import JumlahGuruSwasta from './pendidikan-component/JumlahGuruSwastaCard';
import JumlahMuridCard from './pendidikan-component/JumlahMuridCard';
import JumlahMuridNegeriCard from './pendidikan-component/JumlahMuridNegeriCard';
import JumlahMuridSwastaCard from './pendidikan-component/JumlahMuridSwastaCard';
import DonutGuruCard from './pendidikan-component/DonutGuruCard';
import DonutMuridCard from './pendidikan-component/DonutMuridCard';
import StackedGuruCard from './pendidikan-component/StackedGuruCard';
import StackedMuridCard from './pendidikan-component/StackedMuridCard';
...
export default function Pendidikan() {
  ...
  useEffect(() => {
    fetch('https://api.github.com/repos/luthfimaulidyagithub1/DDA-json/contents/4.1.1.json', {
  ...
  useEffect(() => {
    fetch('https://api.github.com/repos/luthfimaulidyagithub1/DDA-json/contents/4.1.2-4.1.4.json', {
      headers: { Accept: 'application/vnd.github.v3.raw' },
      Authorization: `token ${import.meta.env.VITE_GITHUB_TOKEN}`
    })
      .then((res) => res.json())
  ...
  return (
    <MainCard
      ...
      title={
        ...
        >
          Keadaan Pendidikan Setiap Kecamatan di Kabupaten Sumba Barat, {tahun}
        </Typography>
      }
    >
      <CardContent>
