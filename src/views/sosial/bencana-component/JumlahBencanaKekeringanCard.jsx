// JumlahBencanaKekeringanCard.jsx
...
export default function JumlahBencanaKekeringanCard({ isLoading, data, tahun, kecamatan }) {
  ...
  useEffect(() => {
    ...
    // hitung total dari field "kekeringan"
    const total = filtered.reduce((sum, item) => {
      let val = item['kekeringan'] ?? 0;
                  ...
                  secondary={
                    <>
                      <Typography variant="subtitle2" sx={{ color: '#000', mt: 0.25 }}>
                        Jumlah Kekeringan di Kec. {kecamatan}, {tahun}
                      </Typography>
...
JumlahBencanaKekeringanCard.propTypes = {
