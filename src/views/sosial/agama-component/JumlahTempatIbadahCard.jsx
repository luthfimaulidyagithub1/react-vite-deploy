...
export default function JumlahTempatIbadahCard({ isLoading, data, tahun, kecamatan }) {
  const theme = useTheme();
  const [jumlahIbadah, setJumlahIbadah] = useState(0);
  ...
  useEffect(() => {
    ...
    // hitung total jumlah tempat ibadah
            ...
            <List sx={{ py: 0 }}>
              <ListItem alignItems="center" disableGutters sx={{ py: 0 }}>
                <ListItemAvatar>
                  ...
                  >
                    <TempleBuddhistIcon fontSize="inherit" />
                  </Avatar>
                </ListItemAvatar>
                <ListItemText
                  ...
                  primary={
                    <Typography variant="h4" sx={{ color: '#000' }}>
                      {jumlahIbadah > 0 ? jumlahIbadah.toLocaleString('id-ID') : 'Belum ada data'}
                    </Typography>
                  }
                  secondary={
                    <>
                      <Typography variant="subtitle2" sx={{ color: '#000', mt: 0.25 }}>
                        Jumlah Tempat Ibadah di Kec. {kecamatan}, {tahun}
                      </Typography>
...
JumlahTempatIbadahCard.propTypes = {
