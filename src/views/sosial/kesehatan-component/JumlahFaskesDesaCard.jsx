...
export default function JumlahFaskesDesaCard({ isLoading, data, tahun, kecamatan }) {
  ...
  useEffect(() => {
    ...
    // hitung total desa dengan faskes (field "jumlah desa")
                  ...
                  secondary={
                    <>
                      <Typography variant="subtitle2" sx={{ color: '#000', mt: 0.25 }}>
                        Jumlah Desa yang Memiliki Fasilitas Kesehatan di Kec. {kecamatan}, {tahun}
                      </Typography>
...
JumlahFaskesDesaCard.propTypes = {
