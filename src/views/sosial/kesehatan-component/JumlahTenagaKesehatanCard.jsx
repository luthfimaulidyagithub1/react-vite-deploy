...
const CardWrapper = styled(MainCard)(({ theme }) => ({
  ...
  '&:after': {
    ...
    width: 210,
    height: 210,
    background: `linear-gradient(210.04deg, ${theme.palette.error.dark} -50.94%, rgba(244, 67, 54, 0) 83.49%)`,
    borderRadius: '50%',
    top: -30,
    right: -180
  },
  '&:before': {
    ...
    width: 210,
    height: 210,
    background: `linear-gradient(140.9deg, ${theme.palette.error.dark} -14.02%, rgba(244, 67, 54, 0) 70.50%)`,
    borderRadius: '50%',
    top: -160,
    right: -130
  }
...
export default function JumlahTenagaKesehatanCard({ isLoading, data, tahun, kecamatan }) {
  const theme = useTheme();
  const [jumlahTenaga, setJumlahTenaga] = useState(0);
  ...
  useEffect(() => {
    ...
    // hitung total tenaga kesehatan dari field "jumlah"
                ...
                <ListItemText
                  ...
                  primary={
                    <Typography variant="h4" sx={{ color: '#000' }}>
                      {jumlahTenaga > 0 ? jumlahTenaga.toLocaleString('id-ID') : 'Belum ada data'}
                    </Typography>
                  }
                  secondary={
                    <>
                      <Typography variant="subtitle2" sx={{ color: '#000', mt: 0.25 }}>
                        Jumlah Tenaga Pelayanan Kesehatan di Kec. {kecamatan}, {tahun}
                      </Typography>
...
JumlahTenagaKesehatanCard.propTypes = {
