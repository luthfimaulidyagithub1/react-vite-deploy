...
export default function BarJumlahDesaSekolahCard({ isLoading, data, tahun, kecamatan }) {
  ...
  return (
    <Card sx={{ borderRadius: 2, height: '100%', border: (theme) => `2px solid ${theme.palette.grey[100]}` }}>
      <CardContent sx={{ height: '100%' }}>
        ...
        >
          Jumlah Desa yang Memiliki Fasilitas Sekolah di Kecamatan {kecamatan}, {tahun}
        </Typography>
        ...
        {chartData.length > 0 ? (
          <ResponsiveContainer width="100%" height={350}>
            <BarChart data={chartData} layout="vertical" margin={{ top: 10, right: 30, left: 10, bottom: 10 }}>
              ...
              <Bar dataKey="jumlah" fill={theme.palette.primary.main} name="Jumlah Desa">
                <LabelList
                  dataKey="jumlah"
                  position="right"
...
BarJumlahDesaSekolahCard.propTypes = {
