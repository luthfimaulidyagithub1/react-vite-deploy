...
export default function JumlahHotelCard({ isLoading, data, tahun, kecamatan }) {
  const theme = useTheme();
  const [jumlahHotel, setJumlahHotel] = useState(0);
                ...
                <ListItemText
                  ...
                  primary={
                    <Typography variant="h4" sx={{ color: '#000' }}>
                      {jumlahHotel > 0 ? `${jumlahHotel.toLocaleString('id-ID')} Hotel` : '0 Hotel'}
                    </Typography>
                  }
                  secondary={
                    <>
                      <Typography variant="subtitle2" sx={{ color: '#000', mt: 0.25 }}>
                        Jumlah Hotel di Kec. {kecamatan}, {tahun}
                      </Typography>
