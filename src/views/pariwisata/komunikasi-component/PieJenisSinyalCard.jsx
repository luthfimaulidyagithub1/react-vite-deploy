...
export default function PieJenisSinyalCard({ isLoading, data, tahun, kecamatan }) {
  ...
  useEffect(() => {
    ...
    // kelompokkan berdasarkan jenis sinyal internet telepon seluler
    const grouped = {};
    filtered.forEach((item) => {
      const key = item['jenis sinyal internet telepon seluler'] || 'Tidak Diketahui';
      if (!grouped[key]) grouped[key] = 0;
      grouped[key] += 1; // hitung jumlah desa/kelurahan per kategori
    });
  ...
  return (
    ...
    >
      <CardContent sx={{ display: 'flex', flexDirection: 'column', height: '100%' }}>
        ...
        >
          Distribusi Desa/Kelurahan menurut Jenis Sinyal Internet Telepon Seluler
