...
export default function PieSinyalCard({ isLoading, data, tahun, kecamatan }) {
  ...
  useEffect(() => {
    ...
    // kelompokkan berdasarkan kekuatan sinyal
    const grouped = {};
    filtered.forEach((item) => {
      const key = item['kekuatan sinyal telepon seluler'] || 'Tidak Diketahui';
  ...
  return (
    ...
    >
      <CardContent sx={{ display: 'flex', flexDirection: 'column', height: '100%' }}>
        ...
        >
          Distribusi Desa/Kelurahan menurut Kekuatan Sinyal Telepon Seluler
