...
export default function PieSaranaTransportasiCard({ isLoading, data, tahun, kecamatan }) {
  ...
  useEffect(() => {
    ...
    // kelompokkan berdasarkan jenis sarana transportasi
    const grouped = {};
    filtered.forEach((item) => {
      const key = item['jenis sarana transportasi'] || 'Tidak Diketahui';
  ...
  return (
    ...
    >
      <CardContent sx={{ display: 'flex', flexDirection: 'column', height: '100%' }}>
        ...
        >
          Distribusi Jumlah Desa/Kelurahan menurut Jenis Sarana Transportasi
...
PieSaranaTransportasiCard.propTypes = {
