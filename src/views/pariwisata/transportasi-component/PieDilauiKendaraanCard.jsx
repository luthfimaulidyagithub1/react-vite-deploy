...
export default function PieDilaluiKendaraanCard({ isLoading, data, tahun, kecamatan }) {
  ...
  useEffect(() => {
    ...
    // kelompokkan berdasarkan Dapat Dilalui Kendaraan Bermotor Roda 4 atau Lebih
    const grouped = {};
    filtered.forEach((item) => {
      const key = item['Dapat Dilalui Kendaraan Bermotor Roda 4 atau Lebih'] || 'Tidak Diketahui';
  ...
  return (
    ...
    >
      <CardContent sx={{ display: 'flex', flexDirection: 'column', height: '100%' }}>
        ...
        >
          Distribusi Jumlah Desa/Kelurahan menurut Dapat Dilalui Kendaraan Bermotor Roda 4 atau Lebih
...
PieDilaluiKendaraanCard.propTypes = {
