...
export default function PieAngkutanCard({ isLoading, data, tahun, kecamatan }) {
  ...
  useEffect(() => {
    ...
    // kelompokkan berdasarkan jenis Keberadaan Angkutan Umum
    const grouped = {};
    filtered.forEach((item) => {
      const key = item['Keberadaan Angkutan Umum'] || 'Tidak Diketahui';
  ...
  return (
    ...
    >
      <CardContent sx={{ display: 'flex', flexDirection: 'column', height: '100%' }}>
        ...
        >
          Distribusi Jumlah Desa/Kelurahan menurut Jenis Angkutan Umum
