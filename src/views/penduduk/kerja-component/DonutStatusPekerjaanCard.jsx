...
export default function DonutStatusPekerjaanCard({ isLoading, data, tahun }) {
    ...
    >
      <CardContent sx={{ display: 'flex', flexDirection: 'column', height: '100%' }}>
        ...
        <Typography variant="subtitle1" sx={{ fontWeight: 600, mb: 2, color: theme.palette.text.primary }}>
          Distribusi Penduduk menurut Status Pekerjaan Utama, {tahun}
        </Typography>
...
DonutStatusPekerjaanCard.propTypes = {
