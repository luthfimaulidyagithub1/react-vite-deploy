...
export default function PendudukCard({ isLoading, data, tahun, kecamatan }) {
                ...
                <ListItemText
                  ...
                  primary={
                    <Typography variant="h4" sx={{ color: '#000' }}>
                      {jumlahPenduduk > 0 ? jumlahPenduduk.toLocaleString('id-ID') : 'Belum ada data'}
                    </Typography>
                  }
                  secondary={
                    <>
                      <Typography variant="subtitle2" sx={{ color: '#000', mt: 0.25 }}>
                        Jumlah Penduduk Kec. {kecamatan}
                      </Typography>
