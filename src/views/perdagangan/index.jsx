...
import JumlahPasarPermanenCard from './perdagangan-component/JumlahPasarPermanenCard';
import JumlahPasarSemiPermanenCard from './perdagangan-component/JumlahPasarSemiPermanenCard';
import JumlahPasarTanpaBangunanCard from './perdagangan-component/JumlahPasarTanpaBangunanCard';
import JumlahMinimarketCard from './perdagangan-component/JumlahMinimarketCard';
import JumlahRestoranCard from './perdagangan-component/JumlahRestoranCard';
import JumlahPedagangCard from './perdagangan-component/JumlahPedagangCard';
import BarSaranaPerdaganganDesaCard from './perdagangan-component/BarSaranaPerdaganganCard';
import PiePedagangCard from './perdagangan-component/PiePedagangCard';
import BarPedagangCard from './perdagangan-component/BarPedagangCard';
...
export default function Perdagangan() {
  ...
  const mapRef = useRef();
  // json untuk 7.3
  const [json73, setJson73] = useState([]);
  // json untuk 11.2 KDA
  ...
  // Ambil data 7.3 JSON
  useEffect(() => {
    fetch('https://luthfimaulidyagithub1.github.io/DDA-json/7.3.json', {
  ...
  // Ambil data 11.2 KDA JSON
  useEffect(() => {
    fetch('https://luthfimaulidyagithub1.github.io/DDA-json/11.2%20KDA.json', {
      // headers: { Accept: 'application/vnd.github.v3.raw' }
      // Authorization: `token ${import.meta.env.VITE_GITHUB_TOKEN}`
    })
      .then((res) => res.json())
  ...
  return (
    <MainCard
      ...
      title={
        ...
        >
          Statistik Perdagangan Setiap Kecamatan di Kabupaten Sumba Barat, {tahun}
        </Typography>
      }
    >
      <CardContent>
        ...
        <Grid container spacing={2}>
          <Grid item xs={12} md={6} lg={4}>
            <JumlahPasarPermanenCard isLoading={isLoading} data={json73} tahun={tahun} kecamatan={selectedKecamatan} />
          </Grid>
          <Grid item xs={12} md={6} lg={4}>
