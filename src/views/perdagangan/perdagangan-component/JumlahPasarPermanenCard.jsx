...
export default function JumlahPasarPermanenCard({ isLoading, data, tahun, kecamatan }) {
  ...
  useEffect(() => {
    ...
    // hitung total pasar permanen
    const total = filtered.reduce((sum, item) => {
      let val = item['pasar dengan bangunan permanen'] ?? 0;
                ...
                <ListItemText
                  ...
                  primary={
                    <Typography variant="h4" sx={{ color: '#000' }}>
                      {jumlahPasar > 0 ? `${jumlahPasar.toLocaleString('id-ID')} Pasar Permanen` : '0 Pasar Permanen'}
                    </Typography>
                  }
                  secondary={
                    <>
                      <Typography variant="subtitle2" sx={{ color: '#000', mt: 0.25 }}>
                        Jumlah Pasar Permanen di Kec. {kecamatan}, {tahun}
                      </Typography>
...
JumlahPasarPermanenCard.propTypes = {
