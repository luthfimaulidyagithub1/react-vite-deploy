// JumlahPasarSemiPermanenCard.jsx
...
export default function JumlahPasarSemiPermanenCard({ isLoading, data, tahun, kecamatan }) {
  ...
  useEffect(() => {
    ...
    // hitung total pasar semi permanen
    const total = filtered.reduce((sum, item) => {
      let val = item['pasar dengan bangunan semi permanen'] ?? 0;
                ...
                <ListItemText
                  ...
                  primary={
                    <Typography variant="h4" sx={{ color: '#000' }}>
                      {jumlahPasar > 0 ? `${jumlahPasar.toLocaleString('id-ID')} Pasar Semi Permanen` : '0 Pasar Semi Permanen'}
                    </Typography>
                  }
                  secondary={
                    <>
                      <Typography variant="subtitle2" sx={{ color: '#000', mt: 0.25 }}>
                        Jumlah pasar semi permanen di Kec. {kecamatan}, {tahun}
                      </Typography>
...
JumlahPasarSemiPermanenCard.propTypes = {
