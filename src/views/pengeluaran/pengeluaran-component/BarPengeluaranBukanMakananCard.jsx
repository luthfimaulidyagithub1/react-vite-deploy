// BarPengeluaranBukanMakananCard.jsx
...
export default function BarPengeluaranBukanMakananCard({ isLoading, data, tahun }) {
  ...
  useEffect(() => {
    ...
    // filter tahun & kategori = Bukan Makanan
    let filtered = data.filter((item) => String(item.tahun) === String(tahun) && String(item.kategori).trim() === 'Bukan makanan');
...
BarPengeluaranBukanMakananCard.propTypes = {
