...
export default function PersentaseLuasKabCard({ isLoading, data, tahun, kecamatan }) {
  ...
  useEffect(() => {
    ...
    const total = filtered.reduce((sum, item) => {
      let val = item['persentase terhadap luas kabupaten'] ?? 0;
                ...
                <ListItemText
                  ...
                  primary={
                    <Typography variant="h4" sx={{ color: '#000' }}>
                      {persentase > 0 ? `${persentase.toFixed(2)} %` : 'Belum ada data'}
                    </Typography>
                  }
                  secondary={
                    <>
...
PersentaseLuasKabCard.propTypes = {
