// src/ui-component/cards/statistik/MatahariLineCard.jsx
...
export default function MatahariLineCard({ data = [], tahun, isLoading }) {
  ...
  useEffect(() => {
    ...
    // cari key penyinaran matahari
    const mapped = filtered.map((item) => {
      const keys = Object.keys(item || {});
      const hariKey = keys.find((k) => normalize(k).includes('penyinaranmatahari'));
      return {
        bulan: item?.bulan || '',
      ...
      <CardContent>
        {isLoading ? (
          ...
          <>
            ...
            >
              Penyinaran matahari (%) per Bulan di Stasiun Umbu Mehang Kunda, {tahun}
            </Typography>
                        ...
                        return (
                          ...
                          >
                            ...
                            {payload.map((p, idx) => (
                              ...
                              >
                                Penyinaran matahari: {p.value != null ? p.value.toFixed(2) : '-'} %
                              </Typography>
                            ))}
                          </Box>
                        );
